...
export function ReviewQuizView({
  quizId,
  title,
  subtitle,
  questions,
  ...
  const passingScore = Math.ceil(questions.length * 2 / 3);
      ...
      <div className="p-4 border-b border-gray-100 dark:border-gray-700">
        <div className="max-w-2xl mx-auto flex items-center justify-between">
          ...
          <div className="text-center">
            <p className="text-sm font-medium text-[#FF9500]">{title}</p>
      ...
      <div className="flex-1 overflow-y-auto p-4">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="text-center mb-8">
            ...
            <h2 className="text-xl font-bold text-gray-900 dark:text-white">Review Question</h2>
          </div>
          ...
          <div className="space-y-3 mb-6">
            {question.options.map((option, index) => {
              ...
              if (selectedIndex === index && !showResult) {
                buttonClass = 'bg-orange-50 dark:bg-orange-900 border-2 border-[#FF9500] text-gray-800 dark:text-gray-200';
              }
